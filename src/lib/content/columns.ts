...
export const COLUMNS: Column[] = [
	...
	{
		slug: 'lorawan-toha',
		title: 'LoRaWANとは？農業・畜産での使い方',
		description:
			'LoRaWANの仕組みと特長（長距離・省電力・免許不要の920MHz）を解説。農業のハウスや畜産の鶏舎など、電波が届きにくい現場でのワイヤレス温度監視での使い方を紹介します。',
		category: 'スマート農業',
		datePublished: '2026-07-03',
		readMinutes: 5,
		keywords: ['LoRaWANとは', 'LoRaWAN 農業', '920MHz', 'ワイヤレス 温度監視'],
