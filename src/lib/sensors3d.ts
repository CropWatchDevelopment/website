...
export const SENSORS: Sensor[] = [
	{
		...
		tag: 'CW-AIR-TH',
		blurb:
			'冷蔵・冷凍や飲食の定番モジュール。食品対応の筐体で、気温・相対湿度・露点を、2つのセンサーで確認しながら測ります。',
		measures: ['温度', '湿度', '露点'],
		specs: [
			['精度', '±0.3℃ / ±2%RH'],
			['測定範囲', '−40〜+85℃'],
	...
	},
	{
		...
		tag: 'CW-PPFD',
		blurb:
			'施設園芸向けのクォンタムセンサー。株元（キャノピー）で光合成光量子束密度（PPFD）を測り、DLI（積算光量）も本体で算出します。',
		measures: ['PPFD', 'DLI'],
		specs: [
			['分光範囲', '400〜700nm（PAR）'],
			['出力', 'PPFD µmol/m²/s'],
	...
	},
	{
		...
		tag: 'CW-AIR-THC',
		blurb:
			'空気の状態を、ひとつのモジュールで。NDIR方式のCO₂に加えて温度・湿度も測定。ハウスのVPD算出や、鶏舎の換気アラートに使えます。',
