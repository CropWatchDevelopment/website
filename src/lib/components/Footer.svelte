...
<footer class="bg-gray-600 mt-8" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8">
          ...
          <div class="flex space-x-6">
            ...
            <a href="https://www.youtube.com/@cropwatch4407" class="text-gray-200 hover:text-gray-400">
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
        <p class="text-xs leading-5 text-gray-400">&copy; {new Date().getFullYear()} CropWatch, LLC. All rights reserved.</p>
      </div>
    </div>
  </footer>
