...
<footer class="bg-gray-600 mt-8" aria-labelledby="footer-heading">
	<h2 id="footer-heading" class="sr-only">Footer</h2>
	<div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			<div class="space-y-8">
				<p class="text-sm lg:text-xl leading-10 text-gray-300 lg:leading-10 flex">
					<img class="h-9 lg:h-16 mr-5" src={CropWatchSVG} alt="CropWatch LLC Logo" /> IoT for Everyone
					with CropWatch
				</p>
			...
			<div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
				<div class="md:grid md:grid-cols-1 md:gap-8">
					...
					<div class="mt-10 md:mt-0">
						...
						<ul role="list" class="mt-6 space-y-4">
							<li>
								<a href="/legal/EULA" class="text-sm leading-6 text-gray-300 hover:text-white"
									>EULA</a
								>
							</li>
							<li>
		...
		<div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
			<p class="text-xs leading-5 text-gray-400">
				&copy; {new Date().getFullYear()} CropWatch, LLC. All rights reserved.
			</p>
		</div>
	</div>
</footer>
