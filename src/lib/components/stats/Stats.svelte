<div class="mb-4">
	<dl
		class="mt-5 grid grid-cols-1 divide-y divide-gray-600 overflow-hidden rounded-lg bg-slate-200 shadow md:grid-cols-3 md:divide-x md:divide-y-0"
	>
		<div class="px-4 py-5 sm:p-6">
			<dt class="text-base font-normal text-gray-900">Current Temperature</dt>
			<dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
				<div class="flex items-baseline text-2xl font-semibold text-indigo-600">
					16°C
					<span class="ml-2 text-sm font-medium text-gray-500">14°C</span>
				</div>
		...
		<div class="px-4 py-5 sm:p-6">
			<dt class="text-base font-normal text-gray-900">Humidity</dt>
			<dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
				<div class="flex items-baseline text-2xl font-semibold text-indigo-600">
					58.16%
				</div>
		...
		<div class="px-4 py-5 sm:p-6">
			<dt class="text-base font-normal text-gray-900">Co²</dt>
			<dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
				<div class="flex items-baseline text-2xl font-semibold text-indigo-600">
					824.57%
				</div>
