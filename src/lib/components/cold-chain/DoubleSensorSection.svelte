	...
	<div class="wrap">
		...
		<div class="double-sensor__layout">
			<div class="double-sensor__copy" data-reveal>
				<p>
					<b>SHT43</b>は<b>ISO/IEC 17025:2017認定の個体別3点温度校正（−30℃ / 5℃ / 70℃）</b>を実施しており、年間の温度ドリフトは<b>クラス最高水準の0.01℃未満</b>です。
そのため、<u>SHT43単体で十分に高精度な測定が可能</u>ですが、CropWatchではさらに<u>信頼性を高めるため、もう1台のセンサー(SHT40)を搭載</u>しています。
