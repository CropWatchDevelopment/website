...
const TESTIMONIALS: Testimonial[] = [
	...
	},
	{
		...
		loc: '宮崎県都城市',
		quote:
			'宮崎・都城で種鶏の飼育・ふ化からペットフード・食品まで手がけるエビスグループの一社。鶏舎の温度・湿度を CropWatch のワイヤレスセンサーが24時間見守り、暑さや換気の異常を早めにお知らせ。電池式・配線不要で、長い鶏舎も端から端までカバーします。',
	...
	{
		href: '/cold-chain',
		tag: { icon: 'warehouse', label: '倉庫・物流' },
