	...
	const TESTIMONIALS: Testimonial[] = [
		{
			...
			loc: '宮崎県宮崎市',
			quote:
				'ホテル厨房内にある冷蔵・冷凍庫から、温度・湿度データを自動で収集。日々の忙しい業務の中で各設備を確認し、温度を記録する作業に多くの時間と手間がかかっていましたが、導入後は、Wi-Fiが届かない地下や奥まった場所でも10分ごとにデータを取得できるように。さらに、取得したデータを社内共通ファイルへ自動で反映する仕組みを構築し、確認・記録・入力にかかる負担を大幅に削減。異常時にはメールやパトランプで通知し、設備の不具合や温度異常の早期発見と、迅速な初動対応につなげています。',
