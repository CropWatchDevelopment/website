<script lang="ts">
	...
	import { mdiAccountBadge, mdiAccountLock, mdiAccountLockOpen, mdiDotsGrid, mdiFire, mdiStore } from '@mdi/js';
...
<AppLayout navWidth={0} classes={{ root: 'elevation-0' }}>
	<AppBar>
		...
		<div slot="actions" class="flex gap-3">
			...
			<Tooltip title="Open Twitter / X" placement="bottom" offset={2}>
				<Button
