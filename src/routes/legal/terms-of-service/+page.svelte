	...
	<div class="mx-auto max-w-5xl">
		...
		>
			...
			<section class="relative mb-10 space-y-4">
				...
				<p class="leading-7 text-[var(--cw-blue-900)]/80 dark:text-gray-200">
					合同会社クロップウォッチ（以下「当社」といいます。）が提供するサービス（以下「本サービス」といいます。）では、クッキー（Cookie）その他情報収集モジュール等（以下「クッキー等」といいます。）を使用しています。当社はクッキー等を通じて、本サービスへの利用者のアクセス情報、閲覧情報等を取得することができます。なお、クッキー等を通じて取得するこれらの情報（以下「クッキー情報」といいます。）には、単独で利用者自身を識別し特定できる情報は含まれていません。
				</p>
			</section>
			...
			<section class="relative mb-10 space-y-4">
				...
				<p class="leading-7 text-[var(--cw-blue-900)]/80 dark:text-gray-200">
					利用者は、本サービス上でのクッキー等の使用を許可しない場合、各ブラウザの設定にてクッキー等を無効化してください。ただし、クッキー等を無効にすると、本サービスの利便性が損なわれたり、提供できる機能やサービスの範囲が限定されたりする場合があります。
				</p>
			</section>
			...
			<section class="relative space-y-6">
				<div>
					...
					<p class="mt-3 leading-7 text-[var(--cw-blue-900)]/80 dark:text-gray-200">
				...
				<div class="overflow-hidden rounded-2xl border border-gray-200 shadow-sm dark:border-gray-700">
					<table class="w-full border-collapse text-left text-sm">
						<thead class="bg-[var(--cw-blue-900)] text-white">
							<tr>
								<th class="px-6 py-4 font-semibold">クッキー名称</th>
								<th class="px-6 py-4 font-semibold">送信先</th>
								<th class="px-6 py-4 font-semibold">取得する情報の概要</th>
								<th class="px-6 py-4 font-semibold">利用目的</th>
							</tr>
						</thead>
				...
				<p class="text-sm text-[var(--cw-blue-900)]/80 dark:text-gray-300">
					※Google Analyticsにおけるデータ取り扱いの詳細は
					<a
						href="https://policies.google.com/privacy"
						class="font-semibold text-[var(--cw-blue-600)] underline decoration-dotted underline-offset-4 hover:text-[var(--cw-gold-500)]"
						target="_blank"
