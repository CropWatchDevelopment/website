<!--
  Port of CropWatch/src/lib/components/Icon.svelte — masks a monochrome SVG with
  `currentColor` so the dashboard's toolbar icons pick up the CWUI text tokens.
-->
<script lang="ts">
